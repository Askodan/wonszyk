			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case TestNetworkObject.IDENTITY:
						...
						break;
					case WonszykLogicNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new WonszykLogicNetworkObject(networker, id, frame);
						break;
					case WonszykPlayerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new WonszykPlayerNetworkObject(networker, id, frame);
						break;
				}
